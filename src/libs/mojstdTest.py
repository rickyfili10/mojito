...
# Variabile per tracciare l'indice di scorrimento attuale
scroll_offset = 0
max_visible_options = 6  # Numero massimo di opzioni visualizzabili contemporaneamente
...
def draw_menu(selected_index):
    ...
    for i in range(scroll_offset, min(scroll_offset + max_visible_options, total_options)):
        y = ((i - scroll_offset) * 20) + menu_offset  # Spacing between menu items with offset
